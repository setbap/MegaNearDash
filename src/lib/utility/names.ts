export default {
  APP_NAME: "MegaNearDash",
  SITE_URL: "MegaNearDash.vercel.app",
  BLOCKCHAIN: "Near",
  BLOCKCHAIN_HEADER_GRADIENT: "linear-gradient(to right, #859398, #283048);",
  ...
  BLOCKCHAIN_HEADER_IMAGE_URL: "/logo.svg",
};
