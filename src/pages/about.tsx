      ...
      >
        ...
        >
          <Image
            ...
            height={75}
            src="/og_big.png"
            alt="Near og Image big size"
          />
        </Box>
        <Box position={"absolute"} bottom="8px" width={"100%"} px="8px">
          <HeaderSection title={"elSina"}>
            {`
  __[Page Source | elSina(SETBAP)](https://github.com/setbap/MegaNearDash)__
`}
          </HeaderSection>
        </Box>
      </GridItem>
...
`}
      ...
      <HeaderSection title={"About"}>
        {`
This dashboard is made with love by members of the Near community, in partnership with MetricsDao and Flipside Crypto. We hope it serves as a valuable window into high-level metrics that display the vitality and growth of the Near Blockchain.
